...
for country_path in wikimap_path.glob('*'):
    ns6_dfs += [process_ns6_df(df_path) for df_path in (country_path / 'ns6').glob('*.csv')]

output_path = project_base_path / 'data' / 'processed' / 'wikimap_toolforge' / 'ns6.parquet'
